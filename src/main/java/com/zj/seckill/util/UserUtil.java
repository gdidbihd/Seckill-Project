...
public class UserUtil {
    public static void create(int count) throws Exception {
        ...
        for (int i = 0; i < count; i++) {
            ...
            user.setSlat("Gn3iOamf");// 用户数据表的slat,由程序员设置
        ...
        File file = new File("D:\\Users\\34920\\Desktop\\java_project\\seckill\\src\\main\\resources\\jmeterConfig.txt");
        if (file.exists()) {
            file.delete();
        }
    ...
    private static Connection getConn() throws Exception {
        String url = "jdbc:mysql://192.168.200.146:3306/seckill?useUnicode=true&characterEncoding=UTF-8&serverTimezone=Asia/Shanghai";
        String username = "root";
        String password = "heima123";
